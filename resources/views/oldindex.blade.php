			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.html">
							<img class="logo" src="img/logocsc.png" alt="logo">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							...
							<p class="white-text">Computer Science Club (CSC) est fondé en Mai 2009 par un groupe d'élèves ingénieurs de l'Ecole National des Science Appliquées de Tanger,
                             Il organise des conférences, des ateliers, des formations pour atteindre les objectifs qu'il s'est fixé lors de sa création.
							</p>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="footer-logo">
						<a href="index.html"><img src="img/logocsc.png" alt="logo"></a>
					</div>
					<!-- /footer logo -->
					...
					<div class="footer-copyright">
						<p>Copyright © 2017. All Rights Reserved. Designed by <a href="https://colorlib.com" target="_blank">GINF1</a></p>
					</div>
					<!-- /footer copyright -->
